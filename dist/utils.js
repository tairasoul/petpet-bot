...
const getFrames = makeLazy(() => Promise.all(Array.from({ length: 10 }, (_, i) => canvas.loadImage(`https://raw.githubusercontent.com/VenPlugs/petpet/main/frames/pet${i}.gif`))));
export class PetPetUtils {
    async createGif(profileImage, delay = 20) {
