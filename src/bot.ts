...
const collection: oceanic.Collection<string, Command> = new oceanic.Collection();
...
bot.on("ready", async () => {
    for (const command of commands) {
        ...
        bot.application.createGlobalCommand(command.data as oceanic.CreateApplicationCommandOptions);
